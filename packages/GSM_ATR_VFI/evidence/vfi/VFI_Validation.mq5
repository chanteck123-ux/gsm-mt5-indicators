...
const string SOURCE_SHA256="a44356cdddf4f9eacc625fbf65995cd84b33695954eb0e97e0c80a14b612ac0e";
const string HELPER_SHA256="5fa2d697cca1c962ec10485e90f5e4da649eda7c329d7f5b7fe2d7ed66873004";
// VFI_HELPERS_BEGIN
...
void OnStart()
  {
   ...
   HandRules();
   RunCase("default_tick",520,130,0.20000000000000001,2.5,5,false,0,0);
   RunCase("smooth_tick",520,130,0.20000000000000001,2.5,5,true,0,1);
   RunCase("real_volume",320,30,0.20000000000000001,2.5,5,false,1,2);
   RunCase("real_zero_no_fallback",120,20,0.20000000000000001,2.5,5,false,1,3);
   RunCase("flat_valid_zero",100,7,0.20000000000000001,2.5,5,false,0,4);
   RunCase("zero_tick",100,7,0.20000000000000001,2.5,5,false,0,5);
   RunCase("length1_volume_cap",100,1,0,2.5,1,false,0,6);
   RunCase("short_history",20,7,0.20000000000000001,2.5,5,false,0,7);
   RunCase("vcoef_zero",90,5,0.20000000000000001,0,5,false,0,8);
   RunCase("future_base",240,20,0.20000000000000001,2.5,5,false,0,9);
   RunCase("future_changed",240,20,0.20000000000000001,2.5,5,false,0,10);
   RunCase("prefix_160",160,20,0.20000000000000001,2.5,5,false,0,11);
   RunCase("volume_gap_resume",180,7,0.20000000000000001,2.5,5,false,0,12);
