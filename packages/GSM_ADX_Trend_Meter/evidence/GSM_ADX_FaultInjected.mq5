// TEST ONLY. Original production SHA256=dd9d9843faec00000b9a02ebf039da1373ff7a885061280ad0faf4f7e41b1d96
...
int GSMProductionOnCalculate(const int rates_total,const int prev_calculated,const datetime &time[],const double &open[],
                ...
                const long &volume[],const int &spread[])
  {
   ...
   int calculated=(ADXMethod==PINE_ADX_DI ? rates_total : GSMFaultBarsCalculated(g_handle));
   ...
   int n0=GSMFaultCopyBuffer(g_handle,0,0,requested,T0);
   int n1=GSMFaultCopyBuffer(g_handle,1,0,requested,T1);
   int n2=GSMFaultCopyBuffer(g_handle,2,0,requested,T2);
