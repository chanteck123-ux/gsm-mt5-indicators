...
// Fixed broker symbols in the recorded validation wrapper.
#property tester_indicator "GSM\\GSM_ADX_Trend_Meter.ex5"
#property description "ADX 与同算法内置数据对照；原始 CSV 和真实状态写入 MQL5/Files。"

input string InpSymbols="GOLD,EURUSD";           // 品种列表，逗号分隔；空值自动探测黄金及 EURUSD
...
input string InpOutputStem="GSM_ADX_Compare_Broker"; // 输出文件前缀（不含路径）
